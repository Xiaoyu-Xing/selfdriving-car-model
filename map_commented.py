...
def init():
    ...
    global goal_x
    # y-coordinate of the goal (where the car has to go, that is the airport or the downtown)
    global goal_y
    # initializing the sand array with only zeros
    sand = np.zeros((longueur, largeur))
    # the goal to reach is at the upper left of the map (the x-coordinate is 20 and not 0 because the car gets bad reward if it touches the wall)
    goal_x = 20
...
class Car(Widget):
    ...
    sensor1 = ReferenceListProperty(
        sensor1_x, sensor1_y)  # first sensor vector
    ...
    sensor2 = ReferenceListProperty(
        sensor2_x, sensor2_y)  # second sensor vector
    ...
    sensor3 = ReferenceListProperty(
        sensor3_x, sensor3_y)  # third sensor vector
    # initializing the signal received by sensor 1
    signal1 = NumericProperty(0)
    # initializing the signal received by sensor 2
    signal2 = NumericProperty(0)
    # initializing the signal received by sensor 3
...
class Game(Widget):
    ...
    # getting the sensor 1 object from our kivy file
    ball1 = ObjectProperty(None)
    # getting the sensor 2 object from our kivy file
    ball2 = ObjectProperty(None)
    # getting the sensor 3 object from our kivy file
